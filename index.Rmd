  ...
  div(
    ...
    div(
      ...
      div(
        ...
        tags$strong("get you started with network data"), "and walk you through advanced uses of sigmajs."
      ),
      div(
        class = "col-md-3",
        tags$button(
  ...
  div(
    ...
    div(
      ...
      div(
        ...
        "including sigmajs, to visualise Twitter interactions:",
        br(),
        br(),
        tags$ol(
          tags$li(
        ...
        "The book will get you setup and running with network data if you are unfamiliar with it."
      ),
      div(
        class = "modal-footer",
        tags$a(
