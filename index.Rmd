...
div(
  ...
  div(
    ...
    div(
      ...
      div(
        class = "col-md-10",
        "sigmajs is part of the", a("twinetverse,", href = "http://twinetverse.john-coene.com/", target = "_blank"),
...
*`sigmajs` is part of the [twinetverse](http://twinetverse.john-coene.com/); a universe of packages for Twitter network analysis and visualisation.*