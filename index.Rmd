    ...
    div(
      ...
      div(
        ...
        div(
          ...
          div(
            class = "col-md-8",
            "Follow this", strong("very short"), "guide to grasp the basics of the package."
          ),
          div(
            class = "col-md-4",
            tags$button(
...
`sigmajs` can handle very large graphs thanks to its support of WebGL, below we graph 10,000 nodes (and it can handle much more!). _Note that the package also supports SVG._
