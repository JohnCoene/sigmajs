...
sigmajs(width = "100%", height = 150) %>%
	...
	sg_animate(mapping = list(x = "to_x", y = "to_y", size = "to_size", color = "to_color"),
	           delay = 1000) %>%
	sg_settings(animationsTime = 3000) -> net
  ...
  div(
    ...
    div(
      ...
      div(
        class = "caption",
        h3("Animate"),
        p("Animate the color, size, or position of nodes."),
        p(
          a(
  ...
  div(
    ...
    div(
      ...
      div(
        class = "caption",
        h3("Formats"),
        p("Build graphs from igraph objects or GEXF files."),
        p(
          a(
