...
dyn <- sigmajs(height = 150) %>%
  ...
  sg_add_edges(edges_demo, delay, id, source, target, refresh = TRUE) %>% # read delay documentation
...
`sigmajs` can handle very large graphs thanks to its support of WebGL, below we graph 25,000 nodes. _Note that the package also supports SVG._
